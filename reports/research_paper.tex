...
Conv + corrupt + spec 0.1           & 0.765 & 0.836 & 0.887 & 0.425 & WIN / REC-WIN & Frozen & VICReg$^{*}$ & SSL \\
Conv + SIGReg + corrupt             & 0.775 & 0.825 & 0.904 & 0.363 & WIN / REC-WIN & Frozen & SIGReg & SSL \\
\midrule
\multicolumn{9}{l}{\textit{Conv1D encoder -- fine-tuning and multi-corpus}} \\
...
\multicolumn{9}{l}{%
  ...
  BACC\textsubscript{TUEV} = 6-class macro BACC on TUEV event detection (frozen probe).}
\end{tabular}}
\end{table}
